...
| --- | --- | --- | --- | --- | --- |
| `fixturecheck` | 2026-09-06T07:14:58+00:00 (one) | `86d0f2a` | `ff33f48a1bcaac77` | **97.6%** | 5 read |
| `choir-bench` | _never_ | — | — | — | — |
...
**FAIL** — 3/5 perfect under homr `86d0f2a`, latest as of 2026-09-06T07:14:58+00:00; below 100%: `hanget-soi`, `sammon-ryosto`. Each fixture counts by its own latest result under that homr, so re-running one cannot speak for the others.
