...
| --- | --- | --- | --- | --- | --- |
| `fixturecheck` | 2026-09-05T15:55:57+00:00 (one) | `94b20bd` | `ff33f48a1bcaac77` | **97.5%** | 5 read |
| `choir-bench` | _never_ | — | — | — | — |
...
**FAIL** — 2/5 perfect under homr `94b20bd`, latest as of 2026-09-05T15:55:57+00:00; below 100%: `hanget-soi`, `sammon-ryosto`; holding a unison as one voice: `system4`. Each fixture counts by its own latest result under that homr, so re-running one cannot speak for the others.
...
| 2026-09-05T06:06:01+00:00 | `fixturecheck` | one | `71e6819` | `ff33f48a1bcaac77` | 100.0% |
...
| 2026-09-05T15:55:57+00:00 | `fixturecheck` | one | `94b20bd` | `ff33f48a1bcaac77` | 97.5% |
