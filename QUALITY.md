...
| --- | --- | --- | --- | --- | --- |
| `fixturecheck` | 2026-09-05T14:10:54+00:00 (one) | `8faa87b` | `ff33f48a1bcaac77` | **97.5%** | 5 read |
| `choir-bench` | _never_ | — | — | — | — |
...
**FAIL** — 3/5 perfect under homr `8faa87b`, latest as of 2026-09-05T14:10:54+00:00; below 100%: `hanget-soi`, `sammon-ryosto`. Each fixture counts by its own latest result under that homr, so re-running one cannot speak for the others.
